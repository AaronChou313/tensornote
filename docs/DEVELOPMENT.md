...
v1.1.0 起，Desktop 使用 Tauri 2 并复用同一个 `src/`；v1.2.0 加入受限 Native Workspace 与 Native Git，v1.3.0 加入 Local Runtime Assistant。先安装 Rust stable；macOS Homebrew 用户可运行 `brew install rust`。确认：
