...
export function TopBar() {
  ...
  const trail = noteId && session
    ...
    : location.pathname === '/workspace' ? ['Overview'] : location.pathname === '/knowledge' ? ['Knowledge'] : location.pathname === '/database' ? ['Database'] : location.pathname === '/git' ? ['Git'] : location.pathname === '/settings' ? ['设置'] : []
